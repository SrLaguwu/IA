...
pygame.display.set_caption("Desplazamiento de algoritmo")
...
movimientos = ["Derecha", "Derecha", "Arriba", "Derecha", "Derecha", "Derecha", "Derecha", "Derecha", "Arriba", "Arriba", "Derecha", "Derecha"]
